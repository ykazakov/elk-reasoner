...
public class OwlApiClassExpressionAllSuperClassesQueryTest extends
		BaseQueryTest<OWLClassExpression, OwlAllSuperClassesTestOutput> {
	...
	public OwlApiClassExpressionAllSuperClassesQueryTest(
			final QueryTestManifest<OWLClassExpression, OwlAllSuperClassesTestOutput> manifest) {
		super(manifest,
				new OwlApiReasoningTestDelegate<OwlAllSuperClassesTestOutput>(
						manifest) {

					@Override
					public OwlAllSuperClassesTestOutput getActualOutput()
							throws Exception {
						return new OwlAllSuperClassesTestOutput(
	...
	public static Configuration getConfig()
		...
		return ConfigurationUtils.loadFileBasedTestConfiguration(
				...
				new ConfigurationUtils.ManifestCreator<TestManifestWithOutput<QueryTestInput<OWLClassExpression>, OwlAllSuperClassesTestOutput>>() {

					@Override
					public Collection<? extends TestManifestWithOutput<QueryTestInput<OWLClassExpression>, OwlAllSuperClassesTestOutput>> createManifests(
						...
						try {
							...
							return OwlExpectedTestOutputLoader.load(outputIS)
									.getAllSuperClassesManifests(name,
											urls.get(0));
